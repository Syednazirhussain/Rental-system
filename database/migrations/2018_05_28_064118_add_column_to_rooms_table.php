...
class AddColumnToRoomsTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('rooms', function (Blueprint $table) {
            ...
            $table->decimal('conf_day_price', 10, 2)->nullable();
            $table->decimal('conf_half_day_price', 10, 2)->nullable();
            $table->decimal('conf_cost', 10, 2)->nullable();
            $table->decimal('conf_small_group_price', 10, 2)->nullable();
            $table->decimal('conf_high_price', 10, 2)->nullable();
            $table->decimal('conf_medium_price', 10, 2)->nullable();
            $table->decimal('conf_low_price', 10, 2)->nullable();
            $table->text('conf_termination_cond', 65535)->nullable();
            $table->decimal('conf_vat', 10, 2)->nullable();
            ...
            $table->decimal('rent_monthly_rent', 10, 2)->nullable();
            $table->integer('rent_num_persons')->nullable();
            $table->decimal('rent_vat', 10, 2)->nullable();
            $table->decimal('rent_new_price', 10, 2)->nullable();
