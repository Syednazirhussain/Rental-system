...
class SupportCategoryController extends AppBaseController
{
    ...
    public function show($id)
    {
        ...
        return view('admin.support_categories.show')->with('supportCategory', $supportCategory);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.support_categories.edit')->with('supportCategory', $supportCategory);
    }
