...
class SupportStatusController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.support_statuses.index')
            ->with('supportStatuses', $supportStatuses);
    }
    ...
    {
        return view('admin.support_statuses.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.support_statuses.show')->with('supportStatus', $supportStatus);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.support_statuses.edit')->with('supportStatus', $supportStatus);
    }
