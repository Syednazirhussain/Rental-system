 ...
 * @property \Illuminate\Database\Eloquent\Collection CompanyHr
 ...
 */
class hrCivilStatus extends Model
{
    use SoftDeletes;

    public $table = 'hr_civil_status';
     ...
     **/
    public function companyHrs()
    {
        return $this->hasMany(\App\Models\Company\CompanyHr::class);
    }
}
