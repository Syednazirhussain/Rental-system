                ...
                <div class="wizard-content">
                    ...
                    <form class="wizard-pane" id="wizard-1">
                        ...
                        @if (isset($company))
                            ...
                            <input type="hidden" name="contract_id" id="contract-id"
                                   value="{{ !is_null($company->companySingleContract) ? $company->companySingleContract->id:"" }}"/>
                            <input type="hidden" name="number_hidden" id="contract-no-hidden" class="form-control"
                                   value="{{ !is_null($company->companySingleContract) ? $company->companySingleContract->number:"" }}"/>
                        @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <input type="text" name="number" id="contract-no" class="form-control"
                                       ...
                                       value="{{ (isset($company) && !is_null($company->companySingleContract)) ? $company->companySingleContract->number:'' }}"/>
                                <div class="errorTxt"></div>
                            </div>
                            <div class="col-sm-12 form-group">
                                <label for="contract-description">Contract</label>
                                <textarea name="content" id="contract-content" class="form-control"
                                          rows="10">{{ (isset($company) && !is_null($company->companySingleContract)) ? $company->companySingleContract->content:'' }}</textarea>
                                <div class="errorTxt"></div>
                            </div>
                            <div class="col-sm-6 form-group">
                                <label for="start-date">Start Date</label>
                                <input type="text" name="start_date" id="daterange-3"
                                       value="{{ (isset($company) && !is_null($company->companySingleContract)) ? date('m/d/Y', strtotime($company->companySingleContract->start_date)):'01/01/2018' }}"
                                       class="form-control">
                                <div class="errorTxt"></div>
                            </div>
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="end_date" id="daterange-4"
                                       value="{{ (isset($company) && !is_null($company->companySingleContract)) ? date('m/d/Y', strtotime($company->companySingleContract->end_date)):'12/31/2018' }}"
                                       class="form-control">
                                <div class="errorTxt"></div>
                            </div>
                            <div class="col-sm-6 form-group">
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="number" name="discount" id="discount" class="form-control"
                                       value="{{ (isset($company) && !is_null($company->companySingleContract)) ? $company->companySingleContract->discount:'0' }}">
                                <div class="errorTxt"></div>
                        ...
                        <div class="panel-wide-block p-x-3 p-t-3 b-t-1 bg-white text-xs-right">
                            ...
                            <a href="{!! route('admin.companies.index') !!}" class="btn btn-default"><i
                    ...
                    <!-- =========================== wizard-2 ===================================== -->
                    <form action="{{ route('admin.companies.store') }}" name="createCompanyForm"
                          class="wizard-pane active" id="wizard-2" method="post">
                            ...
                            <div class="col-md-8">
                                ...
                                <fieldset class="form-group">
                                    ...
                                    <input type="text" name="second_name" id="second_name" class="form-control"
                                           placeholder="Second Name" value="{{ isset($company) ? $company->name:'' }}"/>
                                    <div class="errorTxt"></div>
                                </fieldset>
                                ...
                                <fieldset class="form-group">
                                    ...
                                    <textarea name="description" id="description" class="form-control" rows="4"
                                              placeholder="Company Description">{{ isset($company) ? $company->description:'' }}</textarea>
                                    <div class="errorTxt"></div>
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                        @if (isset($company))
                                            <input type="hidden" name="logo-hidden" id="logo-hidden"
                                                   value="{{ $company->logo }}">

                                            <img src="{{ asset('storage/company_logos/'.$company->logo) }}"
                                                 data-src="{{ asset('storage/company_logos/'.$company->logo) }}"
                                                 alt=""/>
                                        @endif
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4 form-group">
                                <fieldset class="form-group">
                                    ...
                                    <select name="country_id" id="country_id" class="form-control select2-country"
                                            style="width: 100%" data-allow-clear="true">
                                        <option></option>
                            ...
                            <div class="col-sm-4 form-group">
                                <fieldset class="form-group">
                                    ...
                                    <select name="state_id" id="state_id" class="form-control select2-state"
                                            style="width: 100%" data-allow-clear="true">
                                        <option></option>
                            ...
                            <div class="col-sm-12 form-group">
                                <fieldset class="form-group">
                                    ...
                                    <input name="address" id="address" type="text" id="address" class="form-control"
                            ...
                            <div class="col-sm-6 form-group">
                                <fieldset class="form-group">
                                    ...
                                    <input name="zipcode" id="zipcode" type="text" id="zipcode" class="form-control"
                                           placeholder="Zipcode" value="{{ isset($company) ? $company->zipcode:'' }}">
                                    <div class="errorTxt"></div>
                                </fieldset>
                            </div>
                            <div class="col-sm-6 form-group">
                                <fieldset class="form-group">
                                    ...
                                    <input name="phone" id="phone" type="text" id="phone" class="form-control"
                                           placeholder="Phone Number"
                                           value="{{ isset($company) ? $company->phone:'' }}">
                                    <div class="errorTxt"></div>
                                </fieldset>
                            </div>
                            <div class="col-sm-6 form-group">
                                <fieldset class="form-group">
                                    ...
                                    <select name="user_status_id" id="user_status_id"
                                            class="form-control select2-status" style="width: 100%"
                                            data-allow-clear="true">
                                        <option></option>
                                        @foreach ($userStatus as $status)
                                            @if (isset($company) && $status->id == $company->userStatus->id)
                                                <option value="{{ $status->id }}"
                                                        selected="selected">{{ ucfirst($status->name) }}</option>
                        ...
                        <div class="panel-wide-block p-x-3 p-t-3 b-t-1 bg-white text-xs-right">
                            ...
                            @else
                                <button type="submit" class="btn btn-primary" id="createCompanyBtn"
                                        data-wizard-action="next">CREATE COMPANY <i class="fa fa-arrow-right m-l-1"></i>
                                </button>
                            @endif
                        </div>
                    ...
                    <form class="wizard-pane" id="wizard-4">
                        ...
                        <button type="button" class="btn btn-primary" id="addBuildingBtn"><i class="fa fa-plus"></i> Add
                            More
                        </button>
                                ...
                                @if (isset($company))
                                    ...
                                    @foreach ($company->companyBuildings as $building)
                                        <div class="buildingFields">
                                            <input type="hidden" name="building_data[{{ $building->id }}][id]"
                                                   class="remove-building-id" value="{{ $building->id }}"/>

                                            <h5 class="bg-success p-x-1 p-y-1">Building <i
                                                        class="fa fa-times fa-lg remove-building pull-right cursor-p"></i>
                                            </h5>
                                            <div class="row">
                                                <div class="col-sm-6 form-group">
                                                    <label for="building-name">Building Name</label>
                                                    <input type="text" name="building_data[{{ $building->id }}][name]"
                                                           data-building="{{ $contactPerson->id }}"
                                                           class="building-name form-control"
                                                           placeholder="Building Name" value="{{ $building->name }}"/>
                                                </div>
                                                <div class="col-sm-6 form-group">
                                                    <label for="building-address">Address</label>
                                                    <input type="text"
                                                           name="building_data[{{ $building->id }}][address]"
                                                           class="building-address form-control"
                                                ...
                                                <div class="col-sm-6 form-group">
                                                    ...
                                                    <input type="text"
                                                           name="building_data[{{ $building->id }}][zipcode]"
                                                           class="building-zip form-control"
                                                           placeholder="Building Zipcode"
                                                ...
                                                <div class="col-sm-6 form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6 form-group">
                                                            <input type="number"
                                                                   name="building_data[{{ $building->id }}][num_floors]"
                                                                   class="building-no-of-floors form-control building-no-of-floors"
                                                                   min="1" value="{{ $building->num_floors }}">
                                                        </div>
                                                        <div class="col-sm-6 form-group">
                                                            <button type="button" class="btn btn-primary addFloorBtn"><i
                                                                        class="fa fa-plus"></i> Add Floors
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div data-building-num="{{ $building->id }}" class="sectionFloor">
                                                @if (isset($companyBuildingFloors[$building->id]))
                                                    @foreach ($companyBuildingFloors[$building->id] as $floor)
                                                        <div class="floor">
                                                            <input type="hidden"
                                                                   name="building_data[{{ $building->id }}][floor][{{ $floor['id'] }}][id]"
                                                                   class="remove-floor-id" value="{{ $floor['id'] }}"/>

                                                            <div class="row">
                                                                <div class="col-sm-6 form-group">
                                                                    <label for="building-floor-no">Floor No.</label>
                                                                    <input type="name"
                                                                           name="building_data[{{ $building->id }}][floor][{{ $floor['id'] }}][floor_number]"
                                                                           class="form-control building-floor-no"
                                                                           placeholder="Floor Name"
                                                                           value="{{ $floor['floor'] }}"/>
                                                                </div>
                                                                <div class="col-sm-6 form-group">
                                                                    <label for="building-floor-no-of-rooms">No. of
                                                                        Rooms</label>
                                                                    <div class="row">
                                                                        <div class="col-sm-6">
                                                                            <input type="number"
                                                                                   name="building_data[{{ $building->id }}][floor][{{ $floor['id'] }}][floor_rooms]"
                                                                                   class="form-control building-floor-no-of-rooms"
                                                                                   min="1"
                                                                                   value="{{ $floor['num_rooms'] }}"/>
                                                                        </div>
                                                                        <div class="col-sm-6">
                    ...
                    <form class="wizard-pane" id="wizard-5">
                        ...
                        <button type="button" class="btn btn-primary" id="addModuleBtn"><i class="fa fa-plus"></i> Add
                            More
                        </button>
                                ...
                                @if (isset($company))
                                    @foreach ($company->companyModules as $comModule)
                                        <div class="moduleFields">
                                            <input type="hidden" name="module[{{ $comModule->id }}][pk]"
                                                   class="remove-module-id" value="{{ $comModule->id }}"/>

                                            <h5 class="bg-success p-x-1 p-y-1">Module <i
                                                        class="fa fa-times fa-lg remove-module pull-right cursor-p"></i>
                                            </h5>
                                            <div class="row">
                                                <div class="col-sm-6 form-group">
                                                    <label for="module">Module</label>
                                                    <select name="module[{{ $comModule->id }}][id]"
                                                            class="module-id form-control" style="width: 100%"
                                                            data-allow-clear="true">
                                                        <option value="0">Select Module</option>
                                                        @foreach ($modules as $module)
                                                            @if ($module->id == $comModule->module_id)
                                                                <option value="{{ $module->id }}"
                                                                        selected="selected">{{ $module->name }}</option>
                                                            @else
                                                ...
                                                <div class="col-sm-6 form-group">
                                                    ...
                                                    <input type="number" name="module[{{ $comModule->id }}][price]"
                                                           class="module-price form-control" min="1"
                                                           value="{{ $comModule->price }}"/>
                                                </div>
                                                '
                                                <div class="col-sm-6 form-group">
                                                    <label for="users_limit">Users Limit</label>
                                                    <input type="number"
                                                           name="module[{{ $comModule->id }}][users_limit]"
                                                           class="users-limit form-control" value="10" min="1"
                                                           value="{{ $comModule->users_limit }}"/>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                    ...
                    <form class="wizard-pane" id="wizard-6">
                        ...
                        <button type="button" class="btn btn-primary" id="addAdminBtn"><i class="fa fa-plus"></i> Add
                            More
                        </button>
                                ...
                                @if (isset($company))
                                    ...
                                    @foreach ($company->companyUsers as $admin)
                                        ...
                                        <div class="adminFields">
                                            <input type="hidden" name="admin[{{ $admin->id }}][id]"
                                                   class="remove-admin-id" value="{{ $admin->id }}"/>
                                            <input type="hidden" name="admin[{{ $admin->id }}][user_id]"
                                                   class="admin-user-id" value="{{ $admin->user->id }}"/>
                                            <input type="hidden" name="admin[{{ $admin->id }}][email_hidden]"
                                                   class="admin-email-hidden" value="{{ $admin->user->email }}"/>
                                            <input type="hidden" name="admin[{{ $admin->id }}][old_password]"
                                                   class="old-password-hidden" value="true"/>

                                            <h5 class="bg-success p-x-1 p-y-1">Admin <i
                                                        class="fa fa-times fa-lg remove-admin pull-right cursor-p"></i>
                                            </h5>
                                            <div class="row">
                                                <div class="col-sm-12 form-group">
                                                    <label for="admin-name">Name</label>
                                                    <input type="text" name="admin[{{ $admin->id }}][name]"
                                                           class="admin-name form-control" placeholder="Admin Name"
                                                           value="{{ $admin->user->name }}">
                                                </div>
                                                <div class="col-sm-12 form-group">
                                                    <label for="admin-email">Email</label>
                                                    <input type="email" name="admin[{{ $admin->id }}][email]"
                                                           class="admin-email form-control" placeholder="Admin Email"
                                                           value="{{ $admin->user->email }}">
                                                </div>
                                                <div class="col-sm-12 form-group">
                                                    <label for="admin-password">Password</label>
                                                    <input type="password" name="admin[{{ $admin->id }}][password]"
                                                           class="admin-pass form-control" placeholder="Admin Password">
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="panel-wide-block p-x-3 p-t-3 b-t-1 bg-white text-xs-right">
                            ...
                            <a href="{!! route('admin.companies.index') !!}" class="btn btn-default"><i
                                        class="fa fa-times"></i> CANCEL</a>
                            <button type="submit" class="btn btn-primary" data-wizard-action="next">FINISH <i
                                        class="fa fa-arrow-right m-l-1"></i></button>
                        </div>
