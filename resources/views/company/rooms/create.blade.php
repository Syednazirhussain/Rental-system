    ...
    <div class="px-content">
        ...
        <div class="row">
                ...
                <div class="panel-body">
                    <form action="javascript:void(0)" method="POST" id="roomForm" enctype="multipart/form-data">
                        <div class="col-md-12">
                            <div class="col-xs-6 col-sm-6 col-md-6">
                               <span class="label label-primary">General Info</span>
                                            {{ csrf_field() }}
                                            @if(isset($room))
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="col-sm-8 m-t-3 form-group">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6" id="rental">
                                <div class="label label-primary pull-right">Rent</div>
                                <div class="col-sm-12 form-group">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6" id="conference">
                                <div class="label label-primary pull-right">Conference</div>

                                <div class="col-sm-12">
                                    <div class="col-md-6">
                                        <label for="conf_day_price">Day Price</label>
                                        <input type="text" id="conf_day_price" name="conf_day_price" class="form-control">
                                                                    <div class="errorTxt"></div>                              
                                    </div>
                                    <div class="col-md-6">
                                        <label for="public_name">Half Day Price</label>
                                        <input type="text" id="conf_half_day_price" name="conf_half_day_price" class="form-control">
                                                                    <div class="errorTxt"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12 form-group">
                                    ...
                                    <input type="text" id="conf_cost" name="conf_cost" class="form-control">
                                                                <div class="errorTxt"></div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="col-sm-3 form-group">
                                        ...
                                        <input type="text" id="conf_sm_price" name="conf_sm_price" class="form-control"> 
                                                                    <div class="errorTxt"></div> 
                                    </div>
                                    <div class="col-sm-3 form-group">
                                        <label for="conf_high_price">High</label>
                                        <input type="text" id="conf_high_price" name="conf_high_price" class="form-control">
                                                                    <div class="errorTxt"></div>
                                    </div>
                                    <div class="col-sm-3 form-group">
                                        <label for="conf_medium_price">Medium</label>
                                        <input type="text" id="conf_medium_price" name="conf_medium_price" class="form-control">
                                                                    <div class="errorTxt"></div>
                                    </div>
                                    <div class="col-sm-3 form-group">
                                        <label for="conf_low_price">Low</label>
                                        <input type="text" id="conf_low_price" name="conf_low_price" class="form-control">
                                                                    <div class="errorTxt"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12 form-group">
                                    ...
                                    <textarea type="text" id="conf_termination_cond" name="conf_termination_cond" class="form-control">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <textarea id="conf_info_internal" name="conf_info_internal" style="display: none;"></textarea>
                                                                <div class="errorTxt"></div>
                                </div>

                                <div class="col-sm-12">
                                    <label for="conf_info_customer_se">Information Customer SE</label>
                                    <textarea id="conf_info_customer_se" name="conf_info_customer_se" style="display: none;"></textarea>
                                                                <div class="errorTxt"></div>
                                </div>

                                <div class="col-sm-12">
                                    <label for="conf_info_customer_en">Information Customer EN</label>
                                    <textarea id="conf_info_customer_en" name="conf_info_customer_en" style="display: none;"></textarea>
                                                                <div class="errorTxt"></div>
                                </div>

                                <div class="col-sm-12">
                                    <label for="conf_info_technical_se">Information Technical SE</label>
                                    <textarea id="conf_info_technical_se" name="conf_info_technical_se" style="display: none;"></textarea>
                                                                <div class="errorTxt"></div>
                                </div>

                                <div class="col-sm-12">
                                    <label for="conf_info_technical_en">Information Technical EN</label>
                                    <textarea id="conf_info_technical_en" name="conf_info_technical_en" style="display: none;"></textarea>
                                                                <div class="errorTxt"></div>
                                </div>
                            </div>
...
<script type="text/javascript">
        ...
        $('#room_module_type').change(function() {
            ...
            {
                $('#conference').show();
                $('#conference').find('input').removeClass('ignore');
                $('#rental').hide();
                $('#rental').find('input').addClass('ignore');
            }
            else
            {
                $('#conference').hide();
                $('#conference').find('input').addClass('ignore');
                $('#rental').show();
                $('#rental').find('input').removeClass('ignore');
            } 
        });

  
// $.validator.setDefaults(
//     { ignore: ":hidden:not(#conf_info_internal,#conf_info_customer_se,#conf_info_customer_en,#conf_info_technical_se,#conf_info_technical_en)" });
