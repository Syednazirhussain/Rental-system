...
@section('content')
    <div class="px-content">
        <div class="page-header">
            <h1><span class="text-muted font-weight-light"><i class="page-header-icon ion-android-checkbox-outline"></i><a href="{{ route('company.roomImages.index') }}">Room Images</a> / </span>Add Room Images</h1>
        </div>
        <div class="row">
