...
@section('content')
     ...
     <div class="px-content">
        <div class="page-header">
            <h1><span class="text-muted font-weight-light"><i class="page-header-icon fa fa-edit"></i>Buildings / Rooms / Room Equipments / Equipments / </span>Edit "{{$equipments->title}}"</h1>
        </div>
        <div class="row">
