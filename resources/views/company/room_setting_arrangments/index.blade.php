...
@section('content')
    <div class="px-content">
        <div class="page-header">
            <h1><span class="text-muted font-weight-light"><i class="page-header-icon ion-ios-keypad"></i><a href="{{ route('company.roomSettingArrangments.index') }}">Room Setting Arrangements</a>  / </span></h1>
        </div>
