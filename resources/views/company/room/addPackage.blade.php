                    ...
                    <div class="panel-body">
                        <form action="" method="POST" id="equipmentForm">
                            		...
                            		<div class="col-sm-12 form-group">
									    ...
									    <input type="text" id="" placeholder="Commercial Package" value="" name="title" class="form-control">
									</div>
							...
							<div class="col-sm-12 m-t-1">
								<button type="submit" class="btn btn-primary"><i class="fa fa-plus"></i>  Add Package </button>
