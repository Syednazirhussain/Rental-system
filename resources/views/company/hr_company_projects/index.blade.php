...
@section('content')
    ...
    <div class="px-content">
        ...
        <div class="page-header">
            <h1><span class="text-muted font-weight-light"><i class="page-header-icon ion-ios-keypad"></i><a href="{{ route('company.hrCompanyProjects.index') }}">Company HR</a> / </span>HR Company Projects</h1>
        </div>
