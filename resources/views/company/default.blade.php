                    ...
                    <li class="dropdown-toggle">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            @if($module->module->name == 'Conference_module')
                                ...
                                <li class="dropdown-toggle">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="{{ route('company.conference.equipmentCriterias.index') }}"><i class="fa fa-wrench"></i>&nbsp;&nbsp;Equipments Criteria</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown-toggle">
                            ...
                            @elseif($module->module->name == 'Newsletter_module')
                                ...
                                <li><a href="{{ route('company.newsletter.dashboard') }}"><i class="fa fa-trello"></i>&nbsp;&nbsp;Dashboard</a>
                                </li>
                                <li><a href="{{ route('company.newsletterGroups.sendmail') }}"><i class="fa fa-paper-plane"></i>&nbsp;&nbsp;Send Mail</a>
                                </li>
                                <li class="dropdown-toggle">
                                    <a href>Group</a>
                                    <ul class="dropdown-menu">
                                        <li><a href="{{ route('company.newsletterGroups.create') }}"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Group</a></li>
                                        <li><a href="{{ route('company.newsletterGroups.index') }}"><i class="fa fa-users"></i>&nbsp;&nbsp;Groups</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown-toggle">
                                    <a href>Customers</a>
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="{{ route('company.newsletterCustomers.list') }}"><i class="fa fa-user"></i>&nbsp;&nbsp;Customers</a></li>
                                    </ul>
                                </li>
                            ...
                            @elseif($module->module->name == 'Rental_module')
                                ...
                                <li class="dropdown-toggle">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="{{ route('company.companyBuildings.index') }}"><i class="fa fa-building"></i>&nbsp;&nbsp;Buildings</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="dropdown-toggle">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="{{ route('company.companyInvoices.index') }}"><i class="fa fa-file-text"></i>&nbsp;&nbsp;Invoices</a>
                                        </li>
                                    </ul>
                                </li>
