...
@section('content')
    ...
    <div class="px-content">
        ...
        <div class="page-header">
            <h1><span class="text-muted font-weight-light"><i class="page-header-icon ion-ios-keypad"></i><a href="{{ route('company.hrVacationCategories.index') }}">Company HR </a> / </span>HR Vacation Categories</h1>
        </div>
