...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-3 form-group">
            ...
            <div class="col-md-7">
                <input class="form-control" name="free_text_1" type="text" id="free_text_1" value="@if(isset($invoice)){{ $invoice->free_text_1 }}@endif">
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-3 form-group">
            ...
            <div class="col-md-7">
                <input class="form-control" name="free_text_2" type="text" id="free_text_2" value="@if(isset($invoice)){{ $invoice->free_text_2 }}@endif">
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-3 form-group">
            ...
            <div class="col-md-7">
                <input class="form-control" name="free_text_3" type="text" id="free_text_3" value="@if(isset($invoice)){{ $invoice->free_text_3 }}@endif">
            </div>
        </div>
    </div>
