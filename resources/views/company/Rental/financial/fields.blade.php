...
<div class="row">
    <div class="col-md-12">
        <div class="col-md-5 form-group">
            <label for="acc_1" class="col-md-4 form-label">ACC 1</label>
            <div class="col-md-8">
                <input class="form-control" name="acc_1" type="text" id="acc_1" value="@if(isset($financial)){{ $financial->acc_1 }}@endif">
            </div>
        </div>
        <div class="col-md-5 form-group">
            <label for="acc_2" class="col-md-4 form-label">ACC 2</label>
            <div class="col-md-8">
    ...
    <div class="col-md-12">
        <div class="col-md-5 form-group">
            <label for="acc_3" class="col-md-4 form-label">ACC 3</label>
            <div class="col-md-8">
                <input class="form-control" name="acc_3" type="text" id="acc_3" value="@if(isset($financial)){{ $financial->acc_3 }}@endif">
            </div>
        </div>
        <div class="col-md-5 form-group">
            <label for="acc_4" class="col-md-4 form-label">ACC 4</label>
            <div class="col-md-8">
    ...
    <div class="col-md-12">
        <div class="col-md-5 form-group">
            <label for="cost_no" class="col-md-4 form-label">Cost Number</label>
            <div class="col-md-8">
                <input class="form-control" name="cost_no" type="number" id="cost_no" value="@if(isset($financial)){{ $financial->cost_no }}@endif">
            </div>
        </div>
        <div class="col-md-5 form-group">
            <label for="project_no" class="col-md-4 form-label">Project Number</label>
            <div class="col-md-8">
    ...
    <div class="col-md-12">
        <div class="col-md-10 form-group">
            <label for="article_no" class="col-md-2 form-label">Article Number Financial System</label>
            <div class="col-md-10">
