...
<div class="px-content">
    <div class="page-header">
        <h1><span class="text-muted font-weight-light"><i class="page-header-icon ion-android-checkbox-outline"></i>Companies / </span>Add
            Company</h1>
    </div>
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="wizard panel-wizard" id="wizard-validation">
                    ...
                    <div class="wizard-content">
                        ...
                        <form action="{{ route('admin.companies.store') }}" name="createCompanyForm"
                              class="wizard-pane active" id="wizard-1" method="post">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        <textarea name="description" id="description" class="form-control" rows="4"
                                                  placeholder="between 20 to 150 characters"></textarea>
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-sm-12 form-group">
                                    <fieldset class="form-group">
                                        ...
                                        <input name="address" id="address" type="text" id="address" class="form-control"
                                               placeholder="ST-12 Phase-3/B Crown Center Alaska.">
                                    </fieldset>
                                </div>
                        ...
                        <form class="wizard-pane" id="wizard-2">
                            ...
                            <button type="button" class="btn btn-primary" id="addFieldBtn"><i class="fa fa-plus"></i>
                                Add More
                            </button>
                            <br><br>
                            ...
                            <div class="panel-wide-block p-x-3 p-t-3 b-t-1 bg-white text-xs-right">
                                <button type="button" class="btn" data-wizard-action="prev"><i
                                            class="fa fa-arrow-left m-r-1"></i> BACK
                                </button>&nbsp;&nbsp;
                                <button type="submit" class="btn btn-primary" data-wizard-action="next">STEP 3 <i
                        ...
                        <form class="wizard-pane" id="wizard-3">
                            ...
                            <button type="button" class="btn btn-primary" id="addBuildingBtn"><i class="fa fa-plus"></i>
                                Add More
                            </button>
                            ...
                            <div class="panel-wide-block p-x-3 p-t-3 b-t-1 bg-white text-xs-right">
                                ...
                                <button type="submit" class="btn btn-primary" data-wizard-action="next">STEP 4 <i
                                            class="fa fa-arrow-right m-l-1"></i></button>
                            </div>
                        ...
                        <form class="wizard-pane" id="wizard-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <input type="text" name="start_date" id="daterange-3" value="10/24/1984"
                                           class="form-control">
                                    <div class="errorTxt"></div>
                                </div>
                                <div class="col-sm-6 form-group">
                                    <label for="end-date">End Date</label>
                                    <input type="text" name="end_date" id="daterange-4" value="10/24/1984"
                                           class="form-control">
                                    <div class="errorTxt"></div>
                                </div>
                                <div class="col-sm-6 form-group">
                                    <fieldset class="form-group">
                                        ...
                                        <select name="payment_method" class="form-control select2-status"
                                                style="width: 100%" data-allow-clear="true">
                                            <option></option>
                                ...
                                <div class="col-sm-6 form-group">
                                    <fieldset class="form-group">
                                        ...
                                        <select name="payment_cycle" class="form-control select2-status"
                                                style="width: 100%" data-allow-clear="true">
                                            <option></option>
                                ...
                                <div class="col-sm-6 form-group">
                                    <fieldset class="form-group">
                                        ...
                                        <select name="discount_type" class="form-control select2-status"
                                                style="width: 100%" data-allow-clear="true">
                                            <option></option>
                            ...
                            <div class="panel-wide-block p-x-3 p-t-3 b-t-1 bg-white text-xs-right">
                                ...
                                <button type="submit" class="btn btn-primary" data-wizard-action="next">STEP 5 <i
                                            class="fa fa-arrow-right m-l-1"></i></button>
                            </div>
                        </form>
                        ...
                        <form class="wizard-pane" id="wizard-5">
                            ...
                            <button type="button" class="btn btn-primary" id="addModuleBtn"><i class="fa fa-plus"></i>
                                Add More
                            </button>
                            ...
                            <div class="panel-wide-block p-x-3 p-t-3 b-t-1 bg-white text-xs-right">
                                ...
                                <button type="submit" class="btn btn-primary" data-wizard-action="next">STEP 6 <i
                                            class="fa fa-arrow-right m-l-1"></i></button>
                            </div>
                        </form>
                        ...
                        <form class="wizard-pane" id="wizard-6">
                            ...
                            <button type="button" class="btn btn-primary" id="addAdminBtn"><i class="fa fa-plus"></i>
                                Add More
                            </button>
                            ...
                            <div class="panel-wide-block p-x-3 p-t-3 b-t-1 bg-white text-xs-right">
                                ...
                                <button type="submit" class="btn btn-primary" data-wizard-action="next"><i
                                            class="fa fa-plus m-r-1"></i> Add Company
                                </button>
                            </div>
                        </form>
